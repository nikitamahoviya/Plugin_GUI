 ...
 * </p>
  */
@Plugin(type = ContextCommand.class, menuPath = "Plugins>PluginPlot1")
public class PluginPlot1 extends ContextCommand {
	//This is an integrated Plugin for VCellPlugin and LinePlot which has Load File as its radio-button
...
//			jp.add(loadVarsAndTimesBtn);
			...
			JRadioButton selectLoadFile = new JRadioButton();
			...
			selectLoadFile.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					new Thread(new Runnable() {
						@Override
...
//			}
			...
			displayProgressBar(false, "Creating GUI...", "VCell Model Loader", 100,uiService);
			int response = JOptionPane.showConfirmDialog(PluginPlot1.mainApplicationFrame
...
//		}
    ...
    private static void displayProgressBar(boolean bShow,String message,String title,int progress,UIService uiService) {
    	if(progressDialog == null) {
			...
			progressDialog = new JDialog(PluginPlot1.mainApplicationFrame,"Checking for VCell Client",false);
...
//				showAndZoom(vcellSelection.varName[varIndex],createDisplayQuietly, 3);
	...
	public static ModuleItem<VCellSelection> getvcellModelsInput(Module module) {
		// TODO Auto-generated method stub
		return null;
	}
}
