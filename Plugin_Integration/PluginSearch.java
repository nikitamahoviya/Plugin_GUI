 ...
 * </p>
  */
@Plugin(type = ContextCommand.class, menuPath = "Plugins>PluginSearch")
public class PluginSearch extends ContextCommand {
...
//			}
			...
			displayProgressBar(false, "Creating GUI...", "VCell Model Loader", 100,uiService);
			int response = JOptionPane.showConfirmDialog(PluginSearch.mainApplicationFrame
...
//		}
    ...
    private static void displayProgressBar(boolean bShow,String message,String title,int progress,UIService uiService) {
    	if(progressDialog == null) {
			...
			progressDialog = new JDialog(PluginSearch.mainApplicationFrame,"Checking for VCell Client",false);
