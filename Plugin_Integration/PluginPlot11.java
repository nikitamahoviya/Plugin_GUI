...
import org.vcell.imagej.plugin.ModelSearch.VCellSelection;
 ...
 * </p>
  */
@Plugin(type = ContextCommand.class, menuPath = "Plugins>PluginPlot11")
public class PluginPlot11 extends ContextCommand {
	//This is an integrated Plugin for VCellPlugin and LinePlot (VCellPlugin+Try of LinePlot) without JRadioButton
...
//			}
			...
			displayProgressBar(false, "Creating GUI...", "VCell Model Loader", 100,uiService);
			int response = JOptionPane.showConfirmDialog(PluginPlot11.mainApplicationFrame
...
//		}
    ...
    private static void displayProgressBar(boolean bShow,String message,String title,int progress,UIService uiService) {
    	if(progressDialog == null) {
			...
			progressDialog = new JDialog(PluginPlot11.mainApplicationFrame,"Checking for VCell Client",false);
