...
@Plugin(type = ContextCommand.class, menuPath = "Plugins>PluginLinePlot1")
public class PluginLinePlot1 extends ContextCommand{
	...
	private int  endIndex = 1321;
  	...
  	@Parameter (choices={"Both the plots","Line Plot by Time", "Time Plot at Data Index"}, style="listBox")
